...
# def ai_bot(spots, inputs):
#     """
#     Simulates the AI opponent's move.
#     :param spots: Dictionary containing the current state of the game board.
#     :param inputs: List containing the positions already chosen by players.
#     :return: True if the AI wins, False otherwise.
#     """
#     open_spots = [spot for spot in spots if spots[spot] != "X" and spots[spot] != "O"]
#     ai_move = random.choice(open_spots)
#
#     spots[ai_move] = "O"
#     inputs.append(ai_move)
#
#     print(f"Computer chose spot {ai_move}")
#
